...
for t in range(args.tries):
    model_dir = "models/text/%s_%s_%s/" %(args.model_type, args.n_topics, t)
    ...
    ctm = ZeroShotTM(bow_size=len(tp.vocab), contextual_size=512, n_components=args.n_topics, model_type=args.model_type)
